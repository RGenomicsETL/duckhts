...
| [`tigerstyle_audit_2026-06-08.md`](tigerstyle_audit_2026-06-08.md) | Open audit note. Structural TigerStyle conformance findings; remediation backlog. | Broad style conformance review and code quality refactor planning across DuckHTS + Rduckhts. |
