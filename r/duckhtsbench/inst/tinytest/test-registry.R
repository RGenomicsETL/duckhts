...
writeLines(c("#!/usr/bin/env sh", "case \"$1\" in", "faidx) printf idx >\"$2.fai\" ;;", "quickcheck) exit 0 ;;", "view) while [ \"$1\" != \"-o\" ]; do shift; done; touch \"$2\" ;;", "index) shift 3; touch \"$1.bai\" ;;", "esac"), samtools)
