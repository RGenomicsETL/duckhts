...
- Preserve `libcurl` in the bundled wasm `htslib` build when the webR toolchain probe finds it, while still disabling plugins, S3, GCS, and LZMA in the stock wasm path.
