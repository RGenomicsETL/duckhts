...
rduckhts_bcf(con, "chr1_variants", bcf_path, region = "1:1-1000")
...
rduckhts_fastq(con, "paired_reads", r1, mate_path = r2)
rduckhts_fastq(con, "interleaved_reads", interleaved, interleaved = TRUE)
...
rduckhts_gff(con, "genes", gff_path, attributes_map = TRUE)
...
rduckhts_bam(con, "cram_reads", cram_path, reference = ref_path)
