 ...
 * Keys include the FASTA and optional FAI/GZI paths. At most eight entries and
 * eight 64-KiB sequence windows are retained per thread; thread exit destroys
 * them. htslib index/transport storage and caller-owned fetch results are separate.
