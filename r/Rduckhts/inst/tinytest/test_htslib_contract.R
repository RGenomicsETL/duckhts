...
test_htslib_contract <- function() {
  ...
  relocated_library <- file.path(
    relocated,
    "lib",
    basename(config$library_file)
  )
  ...
  expect_identical(
    relocated_config$include_dir,
    file.path(relocated, "include")
  )
  ...
  consumer_code <- paste(
    c(
      ...
      paste0(
        "static const char bam_path[] = ",
        c_string(fixture("range.bam")),
        ";"
      ),
      paste0(
        "static const char cram_path[] = ",
        c_string(fixture("range.cram")),
        ";"
      ),
      paste0(
        "static const char reference_path[] = ",
        c_string(fixture("ce.fa")),
        ";"
      ),
      paste0(
        "static const char bcf_path[] = ",
        c_string(fixture("vcf_file.bcf")),
        ";"
      ),
      paste0(
