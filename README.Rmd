...
performs GFF3 structural validation. Attribute decoding can be scalar
(`attributes_map`), grouped and lossless for multi-values (`attributes_list` as
`MAP(VARCHAR, VARCHAR[])`), or exact parser-style pairs (`attributes_pairs` as
