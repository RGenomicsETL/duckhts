...
If you don’t have htslib plugins installed locally, download the prebuilt htslib plugin bundles from the GitHub Releases page and point `HTS_PATH` at the extracted htslib/libexec/htslib directory:
