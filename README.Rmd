...
DuckVEP keeps transcript models immutable and resident while variants remain an
ordinary narrow relation. Production models are prepared from receipted Ensembl
relations with `duckvep_ensembl_*`; this small deterministic model demonstrates
the complete load, annotation, SO decoding, and release lifecycle.
