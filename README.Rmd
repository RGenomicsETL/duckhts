...
A [DuckDB](https://duckdb.org/) extension for reading high-throughput sequencing (HTS)
...
and create DuckDB tables from HTS files. See its README for R-specific usage.
