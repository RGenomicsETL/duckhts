...
- **Ryan Ward**. Author.  
  GenBank reader and FASTA converter

- **Nurture Bio**. Copyright holder.  
  GenBank reader and FASTA converter
...
File Formats Reader Extension*. R package version 1.5.2.9001-0.1.5,
<https://github.com/RGenomicsETL/duckhts>.
    ...
    @Manual{,
      ...
      year = {2026},
      note = {R package version 1.5.2.9001-0.1.5},
