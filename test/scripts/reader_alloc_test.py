...
def main():
    ...
    cases = {
        ...
        "geno-raw-sequential": source("read_geno", "geno_format.vcf",
            ", raw_gt:=true, format_fields:=['AD','DP','GQ','VI','VF','ST'], scan_mode:='sequential'"),
        "geno-raw-indexed": source("read_geno", "geno_calls.vcf.gz",
            ", raw_gt:=true, samples:='S2', region:='chrG:10-30,chrG:20-50'"),
        "geno-raw-no-samples": source("read_geno", "geno_calls.vcf",
            ", raw_gt:=true, samples:=''"),
