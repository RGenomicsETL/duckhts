...
source ordinal before reading comparisons. Twenty additional matrix controls
reject changed fields, repeated case/variant JSON properties and count-preserving
