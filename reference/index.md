...
- [`detect_complex_types()`](https://rgenomicsetl.github.io/duckhts/reference/detect_complex_types.md)
...
- [`extract_map_data()`](https://rgenomicsetl.github.io/duckhts/reference/extract_map_data.md)
  : Extract MAP Keys and Values
- [`normalize_tabix_types()`](https://rgenomicsetl.github.io/duckhts/reference/normalize_tabix_types.md)
