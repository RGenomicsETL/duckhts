...
reuse, instead of hashing tens of gigabytes on every invocation. See
[the corpus workflow](design/duckvep_corpus_workflow.md) for exact
commands, artifact layers, large-corpus derivation, second-machine
reproduction, and the procedure for moving from VEP 116 to the next
release.
