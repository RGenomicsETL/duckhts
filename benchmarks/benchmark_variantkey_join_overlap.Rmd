...
blocks to disk. The measured 665/728 MiB is therefore the resident cost of real
...
providers are scanned one at a time; therefore twelve independent annotations
have approximately the sum of their elapsed times but the maximum of their
individual RSS values. Loading twelve indexes concurrently is neither required
nor the design.
...
one provider shard is the hash-build side and the population relation streams.
