...
On the measured host, uptime load averages (1/5/15 minutes) were 1.40/1.77/1.23 before baseline, 2.27/2.01/1.35 before candidate, and 1.47/1.81/1.32 afterward. The 8,192-row synthetic text aligned-block workload remains 0.020 to 0.022 seconds (median, +10%). A separate 300-execution perf record -F 199 -g -e cycles:u sample of that materialized text input and the same hash summary found 5.58% of candidate cycles in libc \_\_memmove_avx_unaligned_erms (5.32% via duckdb::VectorListBuffer::Reserve); baseline \_\_memmove was below 1%. Child-list copies on geometric growth are consistent with the residual synthetic cost; the sample does not isolate each reserve call’s latency.
...
|:-----------------|:-----------------------------------------------------------------|:-----------------------------------------------------------------|
| revision         | 81edf9bff85ab2daabeccd1daaf13e4bfa39ee47                         | f1fa77ebb1051cd394ba9585b3e68519653029d0                         |
| src_tree         | eaefad637812712f4f261e09a6803c8b65b60e19                         | ee4655d0a17411ae5d6208c4f90d330dc5d6b636                         |
| source_state     | clean                                                            | clean                                                            |
| extension_sha256 | e122aee4aec5d55130bd40f74c379a4e83f1b0e72600a00a95a3d09ebd886689 | fda4aacbe319d2fabed3016008cbd6611ea8a4ce0aeab49b8328d881efba496c |
| source_dir       | /tmp/duckhts-codex257-develop-baseline                           | /root/duckhts-codex257                                           |
| run_utc          | 2026-09-25 18:05:15 UTC                                          | 2026-09-25 18:06:23 UTC                                          |
...
| long_cigar | cigar_query_length         | packed         | 8192           | 8192            | 9856124      | 5           |      0.008 |     0.007 |   0.007 |  0.007 |                0.8750 |              0.8750 |             0.8750 |
...
| ont        | cigar_aligned_blocks       | packed         | 27377          | 25689           | 1408917      | 5           |      0.037 |     0.037 |   0.037 |  0.038 |                1.0000 |              1.0000 |             1.0270 |
| ont        | cigar_aligned_blocks       | text           | 27377          | 25689           | 1408917      | 5           |      0.050 |     0.052 |   0.052 |  0.052 |                1.0400 |              1.0400 |             1.0400 |
| ont        | cigar_aligned_query_length | packed         | 27377          | 25689           | 57342744     | 5           |      0.019 |     0.018 |   0.019 |  0.019 |                0.9474 |              1.0000 |             1.0000 |
...
| ont        | cigar_has_soft_clip        | packed         | 27377          | 25689           | 20131        | 5           |      0.018 |     0.018 |   0.019 |  0.019 |                1.0000 |              1.0556 |             1.0556 |
...
| ont        | cigar_left_soft_clip       | text           | 27377          | 25689           | 937452       | 5           |      0.030 |     0.031 |   0.031 |  0.031 |                1.0333 |              1.0333 |             1.0333 |
| ont        | cigar_query_length         | packed         | 27377          | 25689           | 60050517     | 5           |      0.018 |     0.018 |   0.019 |  0.019 |                1.0000 |              1.0556 |             1.0556 |
| ont        | cigar_query_length         | text           | 27377          | 25689           | 60050517     | 5           |      0.031 |     0.031 |   0.031 |  0.031 |                1.0000 |              1.0000 |             1.0000 |
| ont        | cigar_reference_length     | packed         | 27377          | 25689           | 58809044     | 5           |      0.018 |     0.019 |   0.019 |  0.019 |                1.0556 |              1.0556 |             1.0556 |
| ont        | cigar_reference_length     | text           | 27377          | 25689           | 58809044     | 5           |      0.031 |     0.031 |   0.031 |  0.031 |                1.0000 |              1.0000 |             1.0000 |
| ont        | cigar_right_soft_clip      | packed         | 27377          | 25689           | 958121       | 5           |      0.018 |     0.019 |   0.018 |  0.019 |                1.0556 |              1.0000 |             1.0556 |
| ont        | cigar_right_soft_clip      | text           | 27377          | 25689           | 958121       | 5           |      0.031 |     0.031 |   0.031 |  0.031 |                1.0000 |              1.0000 |             1.0000 |
| ont        | has_op_M                   | packed         | 27377          | 27377           | 25689        | 5           |      0.018 |     0.018 |   0.019 |  0.018 |                1.0000 |              1.0556 |             1.0000 |
