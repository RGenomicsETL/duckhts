...
| frameshift coverage                | -1= 8,399; -2= 8,390; +1= 8,234; +2= 8,323; del= 33,270; delins= 33,346; ins= 33,384; reverse= 50,081; stop_gained= 1,907; terminal_cil_protein_altering= 6; terminal_cil_retained= 50; terminal_endpoint= 4,094; terminal_missing_tail= 0; terminal_nonstop= 50; terminal_reverse= 2,085 |
...
| HGVS shift coverage                | at_vep_limit= 1; composed= 99,834; del= 49,803; dup= 36,148; fwd= 49,742; ins= 50,031; nonlocal_ref_replay= 1,564; protein= 92,951; rev= 50,092; rotated= 19,643; terminal_duplication= 0                                                                                                 |
| HGVSp frameshift coverage          | del= 33,372; delins= 33,328; eligible= 95,852; equal_stop= 24; fs= 90,780; fwd= 47,648; immediate_stop= 5,048; ins= 29,152; non_fs= 4,148; rev= 48,204; shortened= 0; ter_known= 19,079; ter_unknown= 71,701                                                                              |
| HGVSp replay coverage              | del= 3,928; delins= 3,866; dup= 380; equal= 8,477; fwd= 17,270; ins= 1,457; replayed= 34,755; rev= 17,485; special= 64,083; sub= 16,647; terminal_not_applicable= 1,162; vep_position_zero= 1,172; vep_stop_equal= 0                                                                      |
