...
## Revisions and environment
    ...
    ##  candidate 3d1a78509cb074e5211aab2f4119b718b35367f9
    ##                     extension_md5
    ...
    ## pid 4171939's current affinity list: 0,2,4,6
...
is warm; this is not a cold-storage benchmark.
    ...
    ##   baseline    munge       1            0.284        0.284              231224
    ##  candidate    munge       1            0.247        0.246              231008
    ##   baseline     norm       1            0.321        0.321              230984
    ##  candidate     norm       1            0.319        0.319              230864
    ##   baseline    munge       4            0.161        0.603              231140
    ##  candidate    munge       4            0.067        0.258              231356
    ##   baseline     norm       4            0.087        0.336              231172
    ##  candidate     norm       4            0.088        0.335              231208

    ##   revision operator threads run elapsed   cpu
    ##   baseline     norm       1   1   0.322 0.322
    ##   baseline     norm       1   2   0.320 0.320
    ##   baseline     norm       1   3   0.321 0.321
    ##  candidate     norm       1   1   0.319 0.319
    ##  candidate     norm       1   2   0.323 0.322
    ##  candidate     norm       1   3   0.317 0.318
    ##   baseline     norm       4   1   0.089 0.338
    ##   baseline     norm       4   2   0.087 0.336
    ##   baseline     norm       4   3   0.086 0.325
    ##  candidate     norm       4   1   0.089 0.337
    ##  candidate     norm       4   2   0.088 0.334
    ##  candidate     norm       4   3   0.088 0.335
    ##   baseline    munge       1   1   0.279 0.279
    ##   baseline    munge       1   2   0.285 0.284
    ##   baseline    munge       1   3   0.284 0.285
    ##  candidate    munge       1   1   0.248 0.248
    ##  candidate    munge       1   2   0.246 0.246
    ##  candidate    munge       1   3   0.247 0.246
    ##   baseline    munge       4   1   0.161 0.603
    ##   baseline    munge       4   2   0.162 0.609
    ##   baseline    munge       4   3   0.159 0.601
    ##  candidate    munge       4   1   0.069 0.258
    ##  candidate    munge       4   2   0.067 0.259
    ##  candidate    munge       4   3   0.066 0.255
