...
The baseline is an independent `origin/develop` worktree at
`41334c784891caa2df004ff762200094fcdd0aa9` built with
`make configure && make release -j4`; the candidate is
`b26c61e2be45871ba51c40cc3769242c17aaae2d` built with `make release -j4`.
Both revisions are available in this repository. The candidate binary has no
unresolved `duckdb_` symbols (`nm -D -u build/release/duckhts.duckdb_extension`).
