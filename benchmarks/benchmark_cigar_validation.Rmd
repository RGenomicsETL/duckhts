...
The declared outputs are `r paste0(params$prefix, "_{baseline,candidate}_{metadata,inputs,results,timings}.csv")`,
plus `*_mismatches.csv` on an oracle failure. They retain per-repeat elapsed times, minimum/median/maximum times,
